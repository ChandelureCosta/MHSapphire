; <COMPILER: v1.1.29.01>
buildscr = 20
downlurl := "https://github.com/ChandelureCosta/MHSapphire/blob/master/updt.exe?raw=true"
downllen := "https://raw.githubusercontent.com/ChandelureCosta/MHSapphire/master/verlen.ini"
            ...
            if (RegExMatch(chatInput, "^(.*)$", HealNameID))
            {
                ...
                addChatMessageEx("FFFFFF", "Нажать 1 - {008000}Да. {FFFFFF}Нажать 2 - {FF0000}Нет.")
                    ...
                    if (GetKeyState("1", "P"))
                    {
                        ...
                        SendChat("/me открыв мед.сумку, достал" RP1 " историю болезни")
                        Sleep 2000
                        SendChat("/me вписал" RP1 " в пункт ''Имя Фамилия'' - " HealName)
                        Sleep 2000
                        SendChat("/me в пункт ''Лечение'' вписал" RP1 " препарат")
                        Sleep 2000
                        ...
                        Sleep, 150
                        if(color == 4294967057)
                       SendChat("/heal " HealNameID " 200") ;-Гражданские
                        else if(color == 3875209642)
                        SendChat("/heal " HealNameID " 200") ;- АП/Мэрия
                        else if(color == 274771114)
                        SendChat("/heal " HealNameID " 1") ;- МВД
                        else if(color == 851712)
                        SendChat("/heal " HealNameID " 1") ;- ФБР
                        else if(color == 1883378858)
                        SendChat("/heal " HealNameID " 200") ;- МО
                        else if(color == 4283606186)
                        SendChat("/heal " HealNameID " 200") ;- МЗ
                        else if(color == 4283367594)
                        SendChat("/heal " HealNameID " 200") ;- СМИ
                        else if(color == 4293376682)
                        SendChat("/heal " HealNameID " 200") ;- АШ
                        else SendChat("/heal " HealNameID " 200") ;- Остальные
                        Sleep, 2000
                        SendChat("/time")
                    }
...
$~Enter::
{
    if(isInChat() && !isDialogOpen())
    {
                ...
                if (RegExMatch(chatInput, "^(.*)$", MedInspID))
                {
                    ...
                    addChatMessageEx("FFFFFF", "Нажать 1 - {008000}Да. {FFFFFF}Нажать 2 - {FF0000}Нет.")
                        ...
                        if (GetKeyState("1", "P"))
                        {
                            ...
                            Sleep 2000
                            SendChat("/do Лёгкие в норме.")
                            Sleep 2000
                            SendChat("/do На столе эл.тонометр ''ROMN HBP-1120''")
                            Sleep 2000
                            SendChat("/me взял" RP1 " эл.тонометр в руку")
                            Sleep 2000
                            SendChat("/do Эл.тонометр в руке.")
                            Sleep 2000
                            SendChat("/me взял" RP1 " праву руку человека, и закатил" RP1 " рукав")
                            Sleep 2000
                            SendChat("/me надел" RP1 " эл.тонометр ''ROMN HBP-1120'' на правую руку")
                            Sleep 2000
                            SendChat("/do Эл.тонометр на правой руке.")
                            Sleep 2000
                            SendChat("/me нажал" RP1 " на дисплее кнопку ""START""")
                            Sleep 2000
                            SendChat("/do Эл.тонометр начал работать.")
                            Sleep 2000
                            SendChat("/do Спустя одну минуту эл.тонометр показал на дисплее давление, и закончил работу.")
                            Sleep 2000
                            SendChat("/do На дисплее: Давление 120 на 80.")
                            Sleep 2000
                            SendChat("/me снял" RP1 " эл.тонометр с правой руки, и положил на стол")
                            Sleep 2000
                            SendChat("/do Эл.тонометр на столе.")
                            Sleep 2000
                            SendChat("/do В столе лежит пустая мед.карта.")
                            Sleep 2000
                            SendChat("/me открыл" RP1 " дверцу стола")
                            Sleep 2000
                            SendChat("/do Дверца открыта.")
                            Sleep 2000
                            SendChat("/me достал" RP1 " мед.карту и положил" RP1 " её на стол")
                            Sleep 2000
                            SendChat("/do Мед.карта на столе.")
                            Sleep 2000
                            SendChat("/me открыл" RP1 " мед.карту и начал" RP1 " записывать данные")
                            Sleep 2000
                            SendChat("Паспорт ваш.")
                            Sleep 2000
                        addChatMessageEx("{FFFFFF}","{0073A0}[INFO]: {ffffff}Для продолжения подождите пока человек покажет вам паспорт, и нажмите кнопку:{0073A0} 1")
                            KeyWait 1 , D
                            SendChat("/me в пункт ""ФИ"" записал" RP1 "  -  " MedInsp)
                            Sleep 2000
                            SendChat("/me заполнил" RP1 "  пункты: Возраст, национальность, давление, лёгкие.")
                            Sleep 2000
                            SendChat("/do Пункты заполнены.")
                            Sleep 2000
                            nickname := RegExReplace(getUsername(), "_", " ")
        ...
        addChatMessageEx("FFFFFF", "Нажать 1 - {008000}Да. {FFFFFF}Нажать 2 - {FF0000}Нет.")
            ...
            Input, LectureNumber, v, {Enter}
                if (LectureNumber = "1")
                {
                    ...
                    Sleep, 1000
                    SendChat(" ..будут делать уколы и операции.То эти сотрудники будут уволены и занесены в ЧС МЗ.")
                    Sleep, 1000
                ...
                else if (LectureNumber = "2")
                {
                    SendChat(" Уважаемые сотрудники, минуточку внимания!")
                    Sleep, 2000
                    SendChat(" Хочу сообщить Вам, что повышение до должности ''Терапевт'' проходит в любой день после 17:00")
                    Sleep, 2000
                    SendChat(" С должности ''Интерн'' на должность ''Фельдшер'' можно повыситься, сдав речь, ЦП...")
                    Sleep, 2000
                    SendChat(" ... клятву гиппократа.")
                    Sleep, 2000
                ...
                else if (LectureNumber = "3")
                {
                    ...
                    Sleep, 2000
                    SendChat(" (( Речь - это role play отыгровка лечения пациента. ))")
                    Sleep, 2000
                ...
                else if (LectureNumber = "4")
                {
                    ...
                    Sleep, 2000
                    SendChat(" Для безработных граждан - 100$.")
                    Sleep, 2000
                    SendChat(" Для граждан, которые работают в государственных организациях - 200$.")
                    Sleep, 2000
					SendChat(" Исключение: Полиция и ФБР - 1$.")
                    Sleep, 2000
                    SendChat(" Для граждан, которые работают в нелегальных организациях - 200$.")
                    Sleep, 2000
                ...
                else if (LectureNumber = "5")
                {
                    ...
                    Sleep, 2000
                    SendChat(" По будням мы работаем с 07:00 до 21:00. По выходным с 08:00 до 20:00.")
                    Sleep, 2000
                    SendChat(" Обеденные перерывы днем с 13:00 до 14:00, а вечером с 18:00 до 19:00.")
                    Sleep, 2000
                    SendChat(" Спасибо за понимание, удачной работы!")
                    Sleep, 150
                    SendChat("/time")
                ...
                else if (LectureNumber = "6")
                {
                    ...
                    Sleep, 2000
                    SendChat("Так же лечение может проходить только возле палат,либо же в них")
                    Sleep, 2000
                ...
                else if (LectureNumber = "7")
                {
                    ...
                    Sleep, 2000
                    SendChat("Ваша задача учить клятву Гиппократа и сдать Ценовую Политику. ")
                    Sleep, 2000
                ...
                else if (LectureNumber = "8")
                {
                    ...
                    Sleep, 2000
                    SendChat("Вызовы принимать с должночти ''Уч.Врача'' не меньше")
                    Sleep, 2000
                ...
                else if (LectureNumber = "9")
                {
                    ...
                    Sleep, 2000
                    SendChat("Брать машину для развозки медикаментов разрешено с должности Терапевт. ")
                    Sleep, 2000
                    SendChat("Вертолёт разрешено брать только с должности Зам.Глав.Врач и выше. ")
                    Sleep, 2000
        ...
        if(RegExMatch(chatInput, "^/[(Q)(q)][(U)(u)][(A)(a)][(R)(r)][(T)(t)][(Z)(z)]"))
        {
        ...
        if (RegExMatch(chatInput, "^/[(R)(r)][(E)(e)][(P)(o)][(O)(o)][(R)(r)][(T)(t)]"))
        {
        ...
        addChatMessageEx("FFFFFF", "Нажать 1 - {008000}Да. {FFFFFF}Нажать 2 - {FF0000}Нет.")
            ...
            if (GetKeyState("1", "P"))
            {
            showDialog(1, "{0073A0}[INFO]:{FFFFFF} Доклад", "{FFFFFF}Введите время вашего нахождения на посту`n {FFFFFF}Пример: {0073A0}30,45,60,120:","Записать","Закрыть")
            Input, ReportTime, v, {Enter}
                if (ReportTime = "30")
                {
                    nickname := RegExReplace(getUsername(), "_", " ")
                addChatMessageEx("{FFFFFF}","{0073A0}[INFO]:{ffffff} Скрипт запущен, каждые 15 минут, будет происходить доклад в рацию на протяжении: " ReportTime " мин.")
                    ...
                    SendChat("/time")
                    Sleep, 898000
                addChatMessageEx("{FFFFFF}","{0073A0}[INFO]:{ffffff} Сейчас произойдет доклад в рацию, не открывайте чат.")
                    Sleep, 2000
                    SendChat("/r Докладывает: " nickname " | Пост: Регистратура | Состояния: Стабильное")
                    Sleep, 100
                    SendChat("/time")
                ...
                {
                addChatMessageEx("{FFFFFF}","{FF0000}[ERROR] {ffffff}Введено неверное значание. Вводите : {0073A0}время доклада.")
                    Sleep, 100
                    SendChat("Хм...")
                }
            }
        ...
        if(RegExMatch(chatInput, "^/[(S)(s)][(T)(t)][(E)(e)][(R)(r)][(I)(i)][(L)(l)]"))
        {
        addChatMessageEx("{FFFFFF}","{0073A0}[INFO]: {ffffff}Подойдите к резервуарам в операцинной")
            SendChat("/pagesize 20")
            Sleep, 3500
            SendChat("/do Два разделённых резервуара пусты.")
            Sleep, 2000
            SendChat("/me наполнил" RP1 " резервуар слево жидкостью: Вода")
            Sleep, 2000
            SendChat("/do Резервуар полный.")
            Sleep, 2000
            SendChat("/me наполнил" RP1 " резервуар справо жидкостью: Перекись водорода")
            Sleep, 2000
            SendChat("/do Резервуар полный.")
            Sleep, 2000
            SendChat("/time")
        ...
        addChatMessageEx("{FFFFFF}","{0073A0}[INFO]: {ffffff}Для продолжения подойдите к столу и нажмите кнопку:{0073A0} 1")
            ...
            Sleep, 2000
            SendChat("/do В шкафчеке: Стирильный пинцент,полотенце.")
            Sleep, 2000
            SendChat("/me достал" RP1 " из шкафчика пинцент и полотенце")
            Sleep, 2000
            SendChat("/do Пинцент и полотенце в руках.")
            Sleep, 2000
        ...
        SendInput {F8}
            ...
            Sleep, 2000
            SendChat("/me взял" RP1 " в правую руку дырявый пакетик и положил" RP1 " в него режиущие инструменты")
            Sleep, 2000
        ...
        addChatMessageEx("{FFFFFF}","{0073A0}[INFO]: {ffffff}Для продолжения подойдите к столу и нажмите кнопку:{0073A0} 1")
            ...
            Sleep, 2000
            SendChat("/me левой рукой взял" RP1 " фен в руки и включил в резетку")
            Sleep, 2000
        ...
        SendInput {F8}
            ...
            SendChat("/do Фен выключен.")
            Sleep, 2000
            SendChat("/me выключил" RP1 " фен из резетки и положил" RP1 " в шкаф")
            Sleep, 2000
        ...
        if(RegExMatch(chatInput, "^/[(R)(r)][(E)(e)][(V)(v)][(A)(a)][(C)(c)]"))
        {
            Random, V1, 1, 2, 3
            if (V1 = 1)
            V1 := "617"
        ...
        if (RegExMatch(chatInput, "^/[(C)(c)][(N)(n)][(S)(s)]"))
        {
            SendChat("/do Компьютер выключен.")
            Sleep, 2000
            SendChat("/me нажал" RP1 " на кнопку ''Power-ON''")
        ...
        SendInput {F8}
            ...
            Sleep, 2000
            SendChat("/me кликнул" RP1 " на раздел ''Шрифт'', и выбрал шрифт ''Courier new''")
            Sleep, 2000
            SendChat("/me кликнул" RP1 " на раздел ''Размер шрифта'', и выбрал ''16''")
            Sleep, 2000
            ...
            Sleep, 2000
            SendChat("/do Документ успешно сохраннен.")
            Sleep, 2000
            ...
            Sleep, 2000
        SendInput {F8}
            SendChat("/me нажал" RP1 " на раздел ''Переименновать''")
            Sleep, 2000
            ...
            Sleep, 2000
            SendChat("/me нажал" RP1 " два раза на ''Мой копьютер'', и открыл" RP1 " флэшку")
            Sleep, 2000
        ...
        SendInput {F8}
            ...
            Sleep, 2000
            SendChat("/do Пошёл процес копирования.")
            Sleep, 2000
        ...
        if (RegExMatch(chatInput, "^/[(S)(s)][(O)(o)][(M)(m)]"))
        {
            SendChat("/do Компьютер выключен.")
            Sleep, 2000
            SendChat("/me нажал" RP1 " на кнопку ''Power-ON''")
        ...
        SendInput {F8}
            ...
            SendChat("/me кликнул" RP1 " на раздел ''Размер шрифта'', и выбрал ''16''")
            Sleep, 2000
            SendChat("/me нажал" RP1 " на ''Текстовое поле'', и ввел" RP1 " заголовок:''Строение человека''")
            Sleep, 2000
            SendChat("/do Идёт процесс написания статьи.")
            Sleep, 2000
            SendChat("/do Спустя некоторое время статья была написана.")
        ...
        SendInput {F8}
            SendChat("/me нажал" RP1 " на раздел ''Переименновать''")
            Sleep, 2000
            SendChat("/me набрал" RP1 " на клавиатуре ''СТ''")
            Sleep, 2000
            SendChat("/me тыкнул" RP1 " левой кнопки мыши по пустому месту")
            Sleep, 2000
            SendChat("/do ''Документ Word'' успешно переименован в ''СТ''.")
            Sleep, 2000
            SendChat("/do На столе лежит флэшка.")
            Sleep, 2000
            SendChat("/me правой рукой взял" RP1 " флэшку и вставил" RP1 " в ''USB порт''")
        ...
        SendInput {F8}
            ...
            Sleep, 2000
            SendChat("/me наклонил" RP4 " к голове маникена, и запрокинул" RP1 " голову, зажал" RP1 " нос")
            Sleep, 2000
            SendChat("/time")
            Sleep, 150
        SendInput {F8}
            ...
            Sleep, 2000
            SendChat("Вот я вам показал как делать искуственное дыхание.")
            Sleep, 2000
        ...
        SendInput {F8}
            ...
            Sleep, 2000
            SendChat("Встаньте возле стены котора позади меня. Я померяю ваш рост.")
            Sleep, 2000
            SendChat("/time")
            Sleep, 150
        SendInput {F8}
                ...
                if (RegExMatch(chatInput, "^(.*)$", InID))
                {
                    ...
                    addChatMessageEx("FFFFFF", "Нажать 1 - {008000}Да. {FFFFFF}Нажать 2 - {FF0000}Нет.")
                        ...
                        if (GetKeyState("1", "P"))
                        {
                            ...
                            Sleep, 2000
                            SendChat("/do Программа открыталась и показала меню.")
                            Sleep, 2000
                            SendChat("/me выбрал" RP1 " раздел ''Добавить'' и ввел" RP1 " ''" NameInID "''")
                            Sleep, 2000
                            SendChat("/do Человек в базы данных.")
                            Sleep, 2000
                ...
                if (RegExMatch(chatInput, "^(.*)$", InID))
                {
                    ...
                    addChatMessageEx("FFFFFF", "Нажать 1 - {008000}Да. {FFFFFF}Нажать 2 - {FF0000}Нет.")
                        ...
                        if (GetKeyState("1", "P"))
                        {
                            ...
                            Sleep, 2000
                            SendChat("/do Должность в базы данных обновленна.")
                            Sleep, 2000
                            SendChat("/me заблокировал" RP1 " телефон")
                            Sleep, 2000
                            SendChat("/me положил" RP1 " телефон в карман")
                ...
                if (RegExMatch(chatInput, "^(.*)$", InID))
                {
                    ...
                    addChatMessageEx("FFFFFF", "Нажать 1 - {008000}Да. {FFFFFF}Нажать 2 - {FF0000}Нет.")
                        ...
                        if (GetKeyState("1", "P"))
                        {
                            ...
                            SendChat("/me приоткрыл" RP1 " кейс левой рукой")
                            Sleep, 2000
                            SendChat("/me достал новую форму" RP1 " из кейса")
                            Sleep, 2000
                ...
                if (RegExMatch(chatInput, "^(.*)$", EyeTestID))
                {
                    ...
                    addChatMessageEx("FFFFFF", "Нажать 1 - {008000}Да. {FFFFFF}Нажать 2 - {FF0000}Нет.")
                        ...
                        SendInput, {F8}
                            ...
                            Sleep, 2000
                            SendChat("/me снял" RP1 " с плечау мед.сумку и открыл" RP1 " её")
                            Sleep, 2000
                            SendChat("/do В сумке планшет.")
                            Sleep, 2000
                            SendChat("/me взял" RP1 " палншет в руки и включил" RP1 " его")
                            Sleep, 2000
                        ...
                        SendInput, {F8}
                            ...
                            Sleep, 2000
                            SendChat("/me надел" RP1 " сумку на плече")
                            Sleep, 2000
        ...
        SendInput, {F8}
            ...
            Sleep, 2000
            SendChat("/do На экране: Отклонений не обнаруженно.")
            Sleep, 2000
        ...
        SendInput, {F8}
            ...
            Sleep, 2000
            SendChat("Поздравляю у вас отклонений не обнаруженно.")
            Sleep, 2000
            SendChat("/time")
            Sleep, 1000
        SendInput, {F8}
        }
        if (RegExMatch(chatInput, "^/[(В)(b)][(E)(e)][(D)(d)][(C)(c)][(L)(l)][(O)(o)][(T)(t)][(H)(h)][(E)(e)][(S)(s)]"))
        {
            ...
            Sleep, 2000
            SendChat("/me взял" RP1 " наволочку, и вывернул" RP1 " её на изнаку")
            Sleep, 2000
        ...
        if (RegExMatch(chatInput, "^/[(P)(p)][(R)(r)][(E)(e)][(P)(p)][(A)(a)][(R)(r)][(E)(e)][(S)(s)][(T)(t)][(A)(a)][(F)(f)][(F)(f)]"))
        {
        ...
        {
        ShowDialog(0,"{0073A0}[INFO]: {FFFFFF}Список команд","{FFFFFF}- [ 1 ]{0073A0} - Alt + 1{FFFFFF} - Лечение пациента.`n{FFFFFF}- [ 2 ]{0073A0} - /medinsp{FFFFFF} - Проведение мед.осмотра.`n{FFFFFF}- [ 3 ]{0073A0} - /minject{FFFFFF} - Провести укол.`n{FFFFFF}- [ 4 ]{0073A0} - /operation{FFFFFF} - Провести операцию.`n{FFFFFF}- [ 5 ]{0073A0} - /vaccine{FFFFFF} - Провести вакцинацию.`n{FFFFFF}- [ 6 ]{0073A0} - /medvac{FFFFFF} - Провести вакцинацию государственной организации.`n{FFFFFF}- [ 7 ]{0073A0} - /medcheck{FFFFFF} - Провести мед.проверку государственной организации.`n{FFFFFF}- [ 8 ]{0073A0} - /lecture{FFFFFF} - Провести лекцию в рацию.`n{FFFFFF}- [ 9 ]{0073A0} - /fmc{FFFFFF} - Принять вызов, и доложить в общую рацию.`n{FFFFFF}- [ 10 ]{0073A0} - /pricepolicy{FFFFFF} - Ценовая политика.`n{FFFFFF}- [ 11 ]{0073A0} - /kg{FFFFFF} -  Клятва гиппократа.`n{FFFFFF}- [ 12 ]{0073A0} - /quartz{FFFFFF} -  Кварцерование палаты.`n{FFFFFF}- [ 13 ]{0073A0} - /report{FFFFFF} -  Доклады с регистратуры.`n{FFFFFF}- [ 14 ]{0073A0} - /cns{FFFFFF} -  Статья о ''Центральной нервновной системе''.`n{FFFFFF}- [ 15 ]{0073A0} - /som{FFFFFF} -  Статья о ''Строение человека''.`n{FFFFFF}- [ 16 ]{0073A0} - /bt{FFFFFF} -  Анализ крови.`n{FFFFFF}- [ 17 ]{0073A0} - /finsp{FFFFFF} - Полная проверка мед.работника.`n{FFFFFF}- [ 18 ]{0073A0} - /psifs{FFFFFF} - Подготовить хирургические инструменты к операции.`n{FFFFFF}- [ 19 ]{0073A0} - /eyetest{FFFFFF} - Проверить зрение.`n{FFFFFF}- [ 20 ]{0073A0} - /usd{FFFFFF} - УЗИ пациенту.`n{FFFFFF}- [ 21 ]{0073A0} - /preparestaff{FFFFFF} - Подготовить форму для сотрудников.`n{FFFFFF}- [ 22 ]{0073A0} - /bedclothes{FFFFFF} - Поменять постельное.`n{FFFFFF}- [ 23 ]{0073A0} - /sobes{FFFFFF} - Провести собеседование для человека.`n{FFFFFF}- [ 24 ]{0073A0} - /sthelp{FFFFFF} - Список команд для 8+ рангов.`n{FFFFFF}- [ 25 ]{0073A0} - /steril{FFFFFF} - Cтерилизация мед.инструментов.`n{FFFFFF}- [ 26 ]{0073A0} - /medref{FFFFF5F} - Выдать мед.справку.`n{FFFFFF}- [ 27 ]{0073A0} - /revac{FFFFFF} - Пересчет вакцин.`n{FFFFFF}- [ 28 ]{0073A0} - /train{FFFFFF} - Провести тренировку ''Массаж сердца и искусственное дыхание''.`n{FFFFFF}- [ 29 ]{0073A0} - End(кнопка){FFFFFF} - Перезагрузка скрипта.`n                                           {0073A0}Medical Helper modified for sapphire version 2.9.5 by {FFFFFF}Hildebrand Helm`n                                           {0073A0}По поводу доработки скрипта пишем сюда {FFFFFF}vk.com/chandelure", "Закрыть")
            return
        }
        if (RegExMatch(chatInput, "^/[(S)(s)][(T)(t)][(H)(h)][(E)(e)][(L)(l)][(P)(p)]"))
        {
        ShowDialog(0,"{0073A0}[INFO]: {FFFFFF}Список команд","{FFFFFF}- [ 1 ]{0073A0} - /invit{FFFFFF} - Принять во фаракцию.`n{FFFFFF}- [ 2 ]{0073A0} - /uninvit{FFFFFF} - Уволить из фракции.`n{FFFFFF}- [ 3 ]{0073A0} - /offuninvit{FFFFFF} - Уволить из фракции оффлайн.`n{FFFFFF}- [ 4 ]{0073A0} - /post{FFFFFF} - Повысить сотрудника.`n{FFFFFF}- [ 5 ]{0073A0} - /warn{FFFFFF} - Выдать выговор сотруднику.`n{FFFFFF}- [ 6 ]{0073A0} - /skin{FFFFFF} - Поменять форму человеку.`n{FFFFFF}- [ 7 ]{0073A0} - /myskin{FFFFFF} - Сменить свою форму.`n{FFFFFF}- [ 8 ]{0073A0} - /awardone{FFFFFF} - Выписать премию сотруднику.`n{FFFFFF}- [ 9 ]{0073A0} - /awardall{FFFFFF} - Выписать всем премию.`n{FFFFFF}- [ 10 ]{0073A0} - /award{FFFFFF} - Передать конверт с деньгами.`n{FFFFFF}- [ 11 ]{0073A0} - /ordermed{FFFFFF} - Заказать медикаменты.`n{FFFFFF}- [ 12 ]{0073A0} - End(кнопка){FFFFFF} - Перезагрузка скрипта.`n                                           {0073A0}Medical Helper version modified for sapphire 2.9.5 by {FFFFFF}Hildebrand Helm`n                                           {0073A0}По поводу доработки скрипта пишем сюда {FFFFFF}vk.com/chandelure", "Закрыть")
           return
        }
        if (RegExMatch(chatInput, "^/[(P)(p)][(R)(r)][(I)(i)][(C)(c)][(E)(e)][(P)(p)][(O)(o)][(L)(l)][(I)(i)][(C)(c)][(Y)(y)]"))
        {
        showDialog(0, "{0073A0}[INFO]:{FFFFFF} Ценовая Политика", "{0073A0}Цены на лечение{FFFFFF}`n{FFFFFF}- [ 1 ]{0073A0} - Для безработных граждан{FFFFFF} - 100$.`n{FFFFFF}- [ 2 ]{0073A0} - Для граждан, которые работают в государственных организациях{FFFFFF} - 200$, Исключение: ПД и ФБР - 1$.`n{FFFFFF}- [ 3 ]{0073A0} - Для граждан, которые работают в нелегальных организациях{FFFFFF} - 200.`n{0073A0}Цены на вакцины{FFFFFF}`n{FFFFFF}- [ 1 ]{0073A0} VAC - 01{FFFFFF} - 500$.`n{FFFFFF}- [ 2 ]{0073A0} VAC - 02{FFFFFF} - 500$.`n{FFFFFF}- [ 3 ]{0073A0} VAC - 03{FFFFFF} - 500$.`n{FFFFFF}- [ 4 ]{0073A0} VAC - 04{FFFFFF} - 500$.`n                                           {0073A0}Medical Helper modified for sapphire version 2.9.5 by {FFFFFF}Hildebrand Helm`n                                           {0073A0}По поводу доработки скрипта пишем сюда {FFFFFF}vk.com/chandelure","Закрыть")
            return
        }
    }
}
